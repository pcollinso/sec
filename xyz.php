...
if(isset($_POST['action'])){
  ...
  $reply_to_name       = lrtrim($output['reply_to_name']);
  $reply_to_email       = lrtrim($output['reply_to_email']);
    ...
    <div class="row">
      ...
      <div class="panel panel-info" style="border-color: #2CADAD !important; background-color: #444951 !important;">
          ...
          <div style="padding-top: 15px;">
            ...
            <button type="button" class="btn btn-primary collapsed" style="margin-left: 15px;margin-bottom: 10px" > SMTP & OTHER SETUP</button>
        ...
        return jQuery
            ...
            <div class="col-sm-8" style="padding-right: 7.5px !important;">
              ...
              <div style="margin-bottom: 10px" class="input-group">
                ...
                <div style="margin-bottom: 10px" class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-comment"></i></span>
                    <input id="reply_to_name" type="text" class="form-control kanan-l" name="reply_to_name" value="<?php echo $reply_to_name;?>" placeholder="Reply to Name">
                </div>

                <div style="margin-bottom: 10px" class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-comment"></i></span>
                    <input id="reply_to_email" type="text" class="form-control kanan-l" name="reply_to_email" value="<?php echo $reply_to_email;?>" placeholder="Reply to Email">
                </div>
              ...
              <div style="margin-bottom: 5px" class="input-group">
                    ...
                    <input type="text" name="inline" value="<?= isset($_POST['inline']) ? $_POST['inline'] : "";?>" style="width: 50px;border-radius: 4px;padding: 3px 6px;">
                  </div>
                   <div style="margin-bottom: 5px" class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-paperclip"></i><b>Name of attachment (invoice.doc)</b></span>
                    <input type="text" name="inlineatt" value="<?= isset($_POST['inlineatt']) ? $_POST['inlineatt'] : "";?>" style="width: 200px;border-radius: 4px;padding: 3px 6px;">
                  </div>
...
$mail->addAttachment("$my_file", "$my_file");			
                ...
                if(!$mail->Send()){
                  if($default_system!="1"){
                      $result = "Mailer Error: !!<font color=\"#D4001A\"><b> [ ". $mail->ErrorInfo." ]</b></font>";
