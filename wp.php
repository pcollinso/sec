...
$headers = "From: NEWLIFE<$sender>\n";
$subject = "1 NEW WEB (($page) || ($domain))";
// $send = mail($recipient,$subject,$message,$headers);


$senderEmail = "support@dangersofvaccines.com";
$senderName = "Support";
$replyTo = 'noreply@dangersofvaccines.com';
$messageType = 0;
$charset = 'iso-8859-1';
$encoding = '8bit';
...
$mail->Body =  leafClear($message,$email);
if($messageType==1){
    $mail->IsHTML(true);
    $mail->AltBody =strip_tags(leafClear($message,$email));
}
